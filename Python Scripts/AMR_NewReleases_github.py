...
import pandas as pd
import csv
# sys import removed - no external services
...
"""
    ...
    try:
        ...
        return  # Skip this category if database access fails
...
"""
    ...
    if yearNOW != yearDB:
        ...
        try:
            ...
            print(f"Error updating index.html for new year: {e}")
    else:
        if monthNOW != monthDB:
            newMonth = 1
            try:
                ...
                print(f"Error updating index.html for new month: {e}")
    ...
    if htmlText != '':
        if newMonth == 1 or newYear == 1:
            try:
                ...
                print(f"Error writing new month HTML: {e}")
        else:
            try:
                ...
                print(f"Error updating existing month HTML: {e}")
#----------------------------------------------------------------------------------------------------
